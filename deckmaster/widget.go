...
// renderMu serialises USB SetImage calls across concurrent widget goroutines.
...
// on the very next updateWidgets tick.
func (w *BaseWidget) ResetUpdate() {
